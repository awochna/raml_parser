defmodule RamlParser.YamerlIncludeNode do
  ...
  @doc """
  I have no idea what this does or when yamerl calls it. Stole this directly from 
  :yamerl.erlang_atom_node
  """
  ...
  def construct_token(true, token) do
    ...
    nodes = raml_include(module: __MODULE__,
                        tag: @tag,
                        pres: pres,
                        file: text)
    {:finished, nodes}
  ...
  """
  def node_pres(nodes) do
    yamerl_str(nodes, :pres)
  end
end
